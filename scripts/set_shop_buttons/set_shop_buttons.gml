...
function set_shop_buttons() {
	...
	if global.wep >= 1 {text[3] = "PURCHASED"} else {text[3] = "Weapons 1"};
	if global.wep >= 2 {text[4] = "PURCHASED"} else {text[4] = "Weapons 2"};
	if global.wep >= 3 {text[5] = "PURCHASED"} else {text[5] = "Weapons 3"};
