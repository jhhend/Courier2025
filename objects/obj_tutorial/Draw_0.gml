...
draw_text(room_width/2, room_height/5, "TUTORIAL");
...
@"Welcome to COURIER! You are about to embark on your journey of
...
Try it out! ");
    ...
    case 1:
draw_text(room_width/2, room_height/3.75, 
@"Your ship begins with a frail build, bad accuracy, and acts as
...
draw_text(room_width/2, room_height*(2/3)-96, string(alstring))
draw_set_colour(c_white);
draw_set_font(fnt_hud);
...
draw_sprite_ext(spr_arrow, 0 , room_width/2, room_height*(2/3), 2, 2, image_angle+240, c_olive, 1);  
    ...
    case 2:
draw_text(room_width/2, room_height/3.75, 
@"Scattered throughout the galaxies you will visit are pieces of
...
draw_text(room_width/3, room_height*(2/3)+16, "Name: A56X\nDestination: Axion\nStatus: Legal");
draw_set_colour(c_red);
draw_text(room_width*(2/3), room_height*(2/3)+16, "Name: C34Z\nDestination: Majorin\nStatus: Contraband");
    break;
    case 3:
draw_text(room_width/2, room_height/3.75, 
@"Despite the vastness of space, laws still do apply. If
...
draw_sprite_ext(spr_police, 0, room_width/2, room_height*(2/3), 3, 3, image_angle, c_white, 1);
    ...
    case 4:
draw_text(room_width/2, room_height/3.75, 
@"While POLICE will only attack if you have committed a crime,
...
draw_sprite_ext(spr_alien, 0, room_width*.75, room_height*(2/3), 3, 3, image_angle, c_white, 1);
    ...
    case 5:
draw_text(room_width/2, room_height/3.75, 
@"There are three main structures that are of interest. First is
...
draw_sprite_ext(spr_station, 0, room_width*(3/4), room_height*(2/3), 1, 1, image_angle, c_white, 1);
    ...
    case 6:
draw_text(room_width/2, room_height/3.75, 
@"There are also secondary structures that are more difficult to
...
draw_sprite_ext(spr_lasercolor, 1, room_width*(3/4), room_height*(2/3), 1, 1, image_angle, c_red, 1);
    ...
    case 7:
draw_text(room_width/2, room_height/3.75, 
@"Once you have fulfilled their respective requirements, you have
...
draw_sprite_ext(spr_cultistboss, 0, room_width*(4/5), room_height*(2/3), 3, 3, image_angle, c_white, 1);
    ...
    case 8:
draw_text(room_width/2, room_height/3.75, 
@"Joining a faction unlocks a special cargo type and both an
...
draw_text((room_width/5)+16, room_height*(4/8), "Status: Evidence");
draw_text(room_width*(3/5), room_height*(4/8), "Active : [SEARCH]\nPassive: [AUTHORITY]");
draw_set_colour(c_thief);
draw_text((room_width/5)+16, room_height*(5/8), "Status: Weaponry");
draw_text(room_width*(3/5), room_height*(5/8), "Active : [PICKPOCKET]\nPassive: [AFFILIATION]");
draw_set_colour(c_alien);
draw_text((room_width/5)+16, room_height*(6/8), "Status: Organic");
draw_text(room_width*(3/5), room_height*(6/8), "Active : [SWARM]\nPassive: [HIVEMIND]");
draw_set_colour(c_cult);
draw_text((room_width/5)+16, room_height*(7/8), "Status: Ancient");
draw_text(room_width*(3/5), room_height*(7/8), "Active : [CONVERT]\nPassive: [BOND]");
break;
    case 9:
draw_text(room_width/2, room_height/3.75, "The universe has much to offer... Begin your adventure!");
...
draw_set_halign(fa_center);
draw_set_valign(fa_middle);
draw_text(room_width/2, room_width-16, "Press SPACE to continue.");
